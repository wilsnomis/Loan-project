			...
			$user = $_SESSION['SESS_FIRST_NAME'];
					...
					$client ="INSERT INTO client(fname, lname, date_birth, gender, occupation, tel, email, clientphoto,profession,id_type,id_photo,district,couty,sub_county,village,organisation,org_city,org_street,plot_number, org_position,bk_name,bk_contact,bk_occupation,bank_name,bank_branch,bank_account,gross_salary,others,admin) VALUES 
('$fname','$lname','$date','$gender','$occupation','$tel','$email','$clientphoto','$profession','$id','$idimage', '$district','$county','$subcounty','$vill','$orgname','$city','$street','$plotnumber','$position','$gname','$gcontact', '$goccupation','$bbankname','$bbranch','$number','$gross','$other','$user' )";
...
$sql2="SELECT*FROM client WHERE email='$email' AND tel='$tel'";
			...
			$client ="INSERT INTO loan(loan_amount,loan_period,client_id,security,securityphoto,l_plot_number,l_block_number,l_district,l_sub_county,l_village,     accreage) VALUES ('$loanamount','$period','$cid','$security','$securityphoto','$plotnumber','$blocknumber','$district','$subcounty','$landvillage', '$accre')";
