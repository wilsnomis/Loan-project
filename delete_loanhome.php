	  ...
	  <table width="723">
        ...
        <tr>
          <th width="198" rowspan="2" scope="row"><table width="197" align="left" >
            ...
            <tr>
              <th scope="row" align="left"><a href="loan-officerhome.php">Home</a></th>
              </tr>
            <tr>
              <th scope="row"><a href="updating admin.php"></a> </th>
              </tr>
            <tr>
              <th scope="row" align="left"><a href="setloan_interest.php">Set loan interests</a></th>
            </tr>
            <tr>
              <th scope="row">&nbsp;</th>
            </tr>
          ...
          <form id="approve" name="approve" method="post" action="delete_loan.php">
            <table width="258" border="0">
              
              <tr>
                <th colspan="2" scope="col">Cancel  Loan request from here </th>
              </tr>
              <tr>
...
?>
              ...
              <tr>
                <th scope="row">&nbsp;</th>
                <td><input name="delete_loan" type="submit" id="delete_loan" value="Delete Loan" /> 
