        ...
        <tr>
          <th width="210" rowspan="9" scope="row"><fieldset>
            <table width="200" border="0">
              ...
              <tr>
                <th scope="row"><a href="managerhome.php">Home</a></th>
              </tr>
...
*/
        ...
        while($row = mysql_fetch_array( $result )) {
                ...
                echo '<td><a href="manager_editrecord.php?id=' . $row['admin_id'] . '">Edit</a></td>';
                echo '<td><a href="manager_deleterecord.php?id=' . $row['admin_id'] . '">Delete</a></td>';
                echo "</tr>"; 
        } 
        ...
        echo "</table>";
?>
<p><a href="manager_addrecord.php">Add a new record</a></p>
